...
public class Account {
  ...
  //other methods - main method calling both constructors for testing
   public static void main(String[] args){
     Account Tyler = new Account("T1140"); //should print account intialized + all starting values
     System.out.println(Tyler.getAccountNumber()); //should print T1140
     Tyler.charge(3.44); 
     System.out.println(Tyler.getBalance()); //should print 3.44
     Tyler.credit(2.0);
     System.out.println(Tyler.getBalance()); //should print 1.44
     ...
     System.out.println("Test2"); //dividor, only Tyler2 now
     Account Tyler2 = new Account("T2240", 300); //should print account initalized + all starting values 
